...
import {SET_INVENTORY_TABLE_BYSTATUS,REQUEST_SUCCESS,SET_INVENTORY_TABLE,GET_INVENTORY_DEPARTMENT, SET_OFFICE,SET_OPEN_MODAL,GET_NON_INVENTORY, SET_SELECTED_ITEM,SET_OPEN_QTYMODAL, SET_REQ_HEADER, SET_REQ_DTLS, GET_REQUEST_INFO, GET_SINGLEREQUEST_HEADER, GET_SINGLEREQUEST_DETAILS, SET_REQ_FOOTER, GET_DASHBOARD_NUMBERS, SET_STATUS_FOR_TABLE, SET_SEARCH_FOR_TABLE} from "../Types/Inventory_Types";

const auth = window.localStorage.getItem("inventory_token");
const bearer_token = auth;
const bearer = "Bearer " + bearer_token;
export const action_GET_listofrequest_by_status = (todept,status) => async (dispatch) => {
...
export const action_GET_listofrequestsearched = (todept,status,date) => async (dispatch) => {
...
export const action_GET_InsertNewRequest = (deptcode,reqby,todept,reqremarks,requestdetails) => async (dispatch) => {
...
export const action_GET_getsinglerequestheader = (reqno) => async (dispatch) => {
...
export const action_GET_getsinglerequestdetails = (reqno) => async (dispatch) => {
...
export const action_SET_updaterequestApproved = (reqno,apprbycode,apprbyname) => async (dispatch) => {
...
export const action_SET_updaterequestCancelled = (reqno,cancelledbycode,cancelledbyname) => async (dispatch) => {
...
export const action_set_notification = (open,message,type,from,to) => async (dispatch) => {
  var url = `${process.env.REACT_APP_BASE_URL}api/notification`;
  await fetch(url, {
    method: "POST",
    withCredentials: true,
    headers: {
