...
export const action_GET_noticationsby_dept = (dept, offset) => async (
  dispatch
) => {
...
export const action_GET_notications = (title, prio, offset) => async (
  dispatch
) => {
...
export const set_global_sncakbar = (open,message,type) => async (dispatch) => {
